...
PRICE_KEYS=(
  ...
  # Claude 5 models (#1416): commented-anchor rows for the Opus 5, Sonnet 5,
  # and Fable 5.1 baked defaults, same shape as the blocks above.
  PIPELINE_PRICE_CLAUDE_OPUS_5_INPUT
  PIPELINE_PRICE_CLAUDE_OPUS_5_OUTPUT
  PIPELINE_PRICE_CLAUDE_OPUS_5_CACHE_CREATION
  PIPELINE_PRICE_CLAUDE_OPUS_5_CACHE_READ
  PIPELINE_PRICE_CLAUDE_SONNET_5_INPUT
  PIPELINE_PRICE_CLAUDE_SONNET_5_OUTPUT
  PIPELINE_PRICE_CLAUDE_SONNET_5_CACHE_CREATION
  PIPELINE_PRICE_CLAUDE_SONNET_5_CACHE_READ
  PIPELINE_PRICE_CLAUDE_FABLE_5_1_INPUT
  PIPELINE_PRICE_CLAUDE_FABLE_5_1_OUTPUT
  PIPELINE_PRICE_CLAUDE_FABLE_5_1_CACHE_CREATION
  PIPELINE_PRICE_CLAUDE_FABLE_5_1_CACHE_READ
)

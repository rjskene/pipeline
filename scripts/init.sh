...
#PIPELINE_NEXT_BRANCH="next"   # Next-integration branch for breaking work (default: next)
#PIPELINE_NEXT_LABEL="next"    # Label that routes an issue onto PIPELINE_NEXT_BRANCH (legacy alias: next-major-release)
PIPELINE_WIN_TEMP=""

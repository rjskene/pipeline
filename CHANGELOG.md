...
## [0.18.0](https://github.com/rjskene/pipeline/compare/v0.20.1...v0.18.0) (2026-05-28)
...
* **comment-trust:** add enforce-comment-trust PreToolUse hook ([c6db282](https://github.com/rjskene/pipeline/commit/c6db2823540c32969b68a848ad9614a1cca6573f))
* **comment-trust:** add is-trusted-author primitive ([de3b5ea](https://github.com/rjskene/pipeline/commit/de3b5ea0a351f48a23110c69406c47136c778cfe))
* **comment-trust:** add opener-association gate and trusted Classification fallback to plan-issue ([f72fd20](https://github.com/rjskene/pipeline/commit/f72fd20b8fcadc021a93cfb95e39308574f01f6b))
* **comment-trust:** add opener-association gate to classify-issue (refuse-and-surface, no label) ([31ffb86](https://github.com/rjskene/pipeline/commit/31ffb8689bbdd537f69dbb4dbece97ca1c583649))
* **comment-trust:** filter untrusted comments + emit dropped-author audit ([fde6815](https://github.com/rjskene/pipeline/commit/fde681519e9670cfba593b67637cf213713cac6a))
* **comment-trust:** gate attachment ingestion by author trust ([6bbbc02](https://github.com/rjskene/pipeline/commit/6bbbc02370d0698deae8ed3cfd5214bec22c57d9))
* **comment-trust:** gate attachment scan to trusted comment authors ([#548](https://github.com/rjskene/pipeline/issues/548)) ([25ceda9](https://github.com/rjskene/pipeline/commit/25ceda933ec663579620a0d04dcc874e15f2afab))
* **comment-trust:** gate opener-body attachment scan by author trust ([#548](https://github.com/rjskene/pipeline/issues/548)) ([87341b6](https://github.com/rjskene/pipeline/commit/87341b65ac9d1bc8d15240abd3c7779fe33474f5))
* **comment-trust:** gate plan-issue & classify-issue by author association ([3adbf71](https://github.com/rjskene/pipeline/commit/3adbf717928fc124de4468572c6e42c6131cf6ab))
* **comment-trust:** PreToolUse hook enforcing trust-filter usage ([bd4875b](https://github.com/rjskene/pipeline/commit/bd4875b75dd790bf374e2e85b0264c0f9ec24428))
* **comment-trust:** register enforce-comment-trust hook dogfood-only ([05f511b](https://github.com/rjskene/pipeline/commit/05f511b3d11a5b30126ebd63c53934700b3cf69b))
* **comment-trust:** require trusted author for plan comment in evaluate-issue-pr ([177d5fa](https://github.com/rjskene/pipeline/commit/177d5fae969cceab5233da87fe67cc3a71011cad))
* **comment-trust:** require trusted author for plan comment in evaluate-issue-pr ([6b358f2](https://github.com/rjskene/pipeline/commit/6b358f24c921825637605c6b7221e4198068b710))
* **comment-trust:** route classify-issue body/comment reads through trust-filter helper ([8616d77](https://github.com/rjskene/pipeline/commit/8616d7777c871aa7365ab4d97095ef7a2c19c85c))
* **comment-trust:** route plan-issue comment fetch through trust-filter helper ([1d543c5](https://github.com/rjskene/pipeline/commit/1d543c58005a2d2a68e9ccb0127402740bb87811))
* **comment-trust:** scope plan-issue plan-revision detection to trusted feedback ([5d0739a](https://github.com/rjskene/pipeline/commit/5d0739a3521f552d5a57cffca61a8afdb6d2882c))
* **comment-trust:** shared trust-filter helper for untrusted comment authors ([5ca323a](https://github.com/rjskene/pipeline/commit/5ca323a7b61af158d93b8cbee03aa853efa5e503))
...
* **config-drift:** add check-config-drift.sh lint + baseline test ([17e4d98](https://github.com/rjskene/pipeline/commit/17e4d986efc9cd585fd49ad45d0126d33ad6938a))
* **config-drift:** add ORPHAN sub-case + override args for test isolation ([8499246](https://github.com/rjskene/pipeline/commit/8499246d6062e988f9e2907246f33f4b9b551c31))
* **config-drift:** add UNDOCUMENTED sub-case + emit grouped findings ([6d0dc6d](https://github.com/rjskene/pipeline/commit/6d0dc6d85f6fc1d2b2cb128fe0721a7e023a79ca))
* **config-drift:** wire allowlist suppression (exact + concat-prefix matches) ([09af4e4](https://github.com/rjskene/pipeline/commit/09af4e4e5d055abe6a1e1fd4df28796f47b1ba9d))
...
* **config:** check-config-drift.sh lint + CI wiring for PIPELINE_* declared-vs-referenced symmetry ([b1ce45a](https://github.com/rjskene/pipeline/commit/b1ce45a613d7ad28ebe2298de2b8d47a732f630b))
...
* **execute-issue-plan:** copy pipeline.config into worktrees so Boot resolves PIPELINE_* ([#529](https://github.com/rjskene/pipeline/issues/529)) ([72b1ef6](https://github.com/rjskene/pipeline/commit/72b1ef62f00cc271ca983335492b94cc28761f4d))
* **execute-issue-plan:** resolve pipeline.config inside worktrees (boundary-hook workaround) ([e5574f5](https://github.com/rjskene/pipeline/commit/e5574f5263cd22ecec647f68133b63f2c95c68d7))
...
* **visual-proof:** route evaluate-issue-pr Step 6c through server-start helper for [#527](https://github.com/rjskene/pipeline/issues/527) ([4471f8c](https://github.com/rjskene/pipeline/commit/4471f8c9fc67d52068851ac03c47bae05eac0ecf))
* **visual-proof:** server-start composes broker + starts loopback http.server for [#527](https://github.com/rjskene/pipeline/issues/527) ([cdf8f9f](https://github.com/rjskene/pipeline/commit/cdf8f9fb44c538cadaab783356d6a40519b30c9a))
* **visual-proof:** single-issue orchestrator path missing static-server bootstrap (PR [#519](https://github.com/rjskene/pipeline/issues/519) follow-up) ([ddeda18](https://github.com/rjskene/pipeline/commit/ddeda184fbeed7f0ac800eaf899bec9d03d9746e))
...
* **comment-trust:** gate evaluate-issue-plan plan selection by trusted author ([#565](https://github.com/rjskene/pipeline/issues/565)) ([e8e5ea0](https://github.com/rjskene/pipeline/commit/e8e5ea0ac697e197e7d35b205c9e0ece0332c820))
* **config:** consume drift-lint output to delete orphans + document undocumented PIPELINE_* vars ([bfeb6e3](https://github.com/rjskene/pipeline/commit/bfeb6e3179cef1faecd1c826a65237d92c629047))
...
* **eval:** branch screenshot embed form by repo visibility; document private blob path ([#551](https://github.com/rjskene/pipeline/issues/551)) ([6197bca](https://github.com/rjskene/pipeline/commit/6197bcaedf6f620712e625651a24ce092ac20ab9))
* **eval:** emit blob screenshot URL on private repos, fail-soft to raw ([#551](https://github.com/rjskene/pipeline/issues/551)) ([9cccfe8](https://github.com/rjskene/pipeline/commit/9cccfe86e4f37a610fa4266ee951fe9878918354))
* **eval:** rewrite blob screenshot URLs to merge-SHA on private repos ([#551](https://github.com/rjskene/pipeline/issues/551), [#506](https://github.com/rjskene/pipeline/issues/506)) ([da54238](https://github.com/rjskene/pipeline/commit/da54238065d42d85a1619e15494423db7ec9763d))
...
* evaluation fixes for [#551](https://github.com/rjskene/pipeline/issues/551) — drop pipefail from screenshot-wiring test to kill SIGPIPE flakiness ([5f2dbb7](https://github.com/rjskene/pipeline/commit/5f2dbb79e1b770c20cbbaba1b2eaff59bbec2c2f))
...
* **release-please:** Release-As: X.Y.Z-rc.N drops the -rc suffix and emits a stable Release PR when latest tag is stable ([bcf9f06](https://github.com/rjskene/pipeline/commit/bcf9f06f20fcbe15cce63fc56595272a6268bdd3))
...
* **review:** document --json/--comments coverage gaps in enforce-comment-trust ([67288f7](https://github.com/rjskene/pipeline/commit/67288f7c4c555ce4c6469ed6c3e3a8f347d8b6c3))
...
* **review:** harden trust gate for degraded states ([#548](https://github.com/rjskene/pipeline/issues/548)) ([dfe8650](https://github.com/rjskene/pipeline/commit/dfe86507a8de4024ce1643c0e30d4b4be9d895e6))

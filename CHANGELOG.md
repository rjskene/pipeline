...
## [0.23.26](https://github.com/rjskene/pipeline/compare/v0.23.25...v0.23.26) (2026-09-21)


### Features

* **config:** document PIPELINE_LOGS_RETENTION_DAYS ([98f583d](https://github.com/rjskene/pipeline/commit/98f583dec63a432e9243e0077e499bad5acc22bb))
* **filter-trusted-comments:** add --json mode emitting trusted-only comments ([f0a6206](https://github.com/rjskene/pipeline/commit/f0a6206d9b6f46a091c800279eca43591bd0346a))
* **filter-trusted-comments:** add fetch-attachments subcommand ([#1340](https://github.com/rjskene/pipeline/issues/1340)) ([4b1caf1](https://github.com/rjskene/pipeline/commit/4b1caf19b1b3694e91e71862f85ec75f5af88e0a))
* **hooks:** add fail-open _deny_log helper ([9703511](https://github.com/rjskene/pipeline/commit/970351110646c587729b15a13bcacf8f8f8a0f57))
* **hooks:** command_mask shared heredoc/quoted-operand masking helper ([#1321](https://github.com/rjskene/pipeline/issues/1321)) ([443a39e](https://github.com/rjskene/pipeline/commit/443a39e0bae0d958c36960e611df944f9daea90d))
* **hooks:** log denials from restrict_paths, ci-wait and path-c guards ([474666f](https://github.com/rjskene/pipeline/commit/474666f81ec70c0cc86dceb6b6868604d41d7dd0))
* **hooks:** log denials from the four command-scanning guards ([97547d5](https://github.com/rjskene/pipeline/commit/97547d5d5baabeb2b95a61fac8d63026a5315253))
* **hooks:** log PreToolUse denials to hook-denials.jsonl ([#1352](https://github.com/rjskene/pipeline/issues/1352)) ([c0c0d3f](https://github.com/rjskene/pipeline/commit/c0c0d3f9a9cf528621c4fed0e4e9d729a5cf6e5f))
* **logs:** add prune-logs.sh retention pass ([ec93e53](https://github.com/rjskene/pipeline/commit/ec93e53e23957dfc62b233beb8ed80738d9bcdf8))
* **logs:** prune-logs.sh retention pass for .claude/logs ([#1353](https://github.com/rjskene/pipeline/issues/1353)) ([838580b](https://github.com/rjskene/pipeline/commit/838580be09bec29080cbb2a6131bfaa0d04335d0))
* **run-test-suite:** --changed-only runs the diff's touched + subject tests ([#1334](https://github.com/rjskene/pipeline/issues/1334)) ([9197367](https://github.com/rjskene/pipeline/commit/91973676143ec4ee440685323da491c7056eb152))
* **run-test-suite:** --changed-only runs the diff's touched + subject tests; execute Step 6b uses it when base CI is green ([f045d69](https://github.com/rjskene/pipeline/commit/f045d69d3107ec60d71bfc0ba33b18921389fe77))
* **status:** relay prune-logs dry-run summary in housekeeping ([f8c558f](https://github.com/rjskene/pipeline/commit/f8c558f272894e76fae95b52c6736f097d8532ed))
* **test-suite:** fail the run when a test leaks a worktree or branch ([#1316](https://github.com/rjskene/pipeline/issues/1316)) ([2c45c0b](https://github.com/rjskene/pipeline/commit/2c45c0bf761987268d37dfd2e13ca83b8aa9ca47))


### Bug Fixes

* **calib:** disable the print-mode background wait ceiling in the calibration launch ([98ff345](https://github.com/rjskene/pipeline/commit/98ff3453c3da900c55c8d6faa0b608f5aa87e4c3)), closes [#1306](https://github.com/rjskene/pipeline/issues/1306)
* **calibration-run:** --reset closes open sandbox PRs and deletes remote feature branches ([deae301](https://github.com/rjskene/pipeline/commit/deae3018eb35a2f4cb98ab9186670b9b132b4e32)), closes [#1333](https://github.com/rjskene/pipeline/issues/1333)
* **calibration-run:** --reset closes open sandbox PRs and deletes remote feature branches (backlog [#51](https://github.com/rjskene/pipeline/issues/51)) ([6ff374f](https://github.com/rjskene/pipeline/commit/6ff374f64eb43b0e24ef0d1acca5c941c4a5956b))
* **comment-trust:** route fullsend Step 1a / plan-issue Step 3b attachment ingest through filter-trusted-comments.sh fetch-attachments (backlog [#46](https://github.com/rjskene/pipeline/issues/46)) ([5c3e67b](https://github.com/rjskene/pipeline/commit/5c3e67b41c10f833ecac7f107e137de4ba064814))
* evaluation fixes for [#1282](https://github.com/rjskene/pipeline/issues/1282) — keep the Windows scratchpad substring arm off the POSIX branch ([bece1be](https://github.com/rjskene/pipeline/commit/bece1bec59c2bb942a50f19e2e33a9f529b5874e))
* evaluation fixes for [#1321](https://github.com/rjskene/pipeline/issues/1321) — close backslash-alias, xargs and brace/glob escapes around the head anchor and the temp carve-out ([5548d3a](https://github.com/rjskene/pipeline/commit/5548d3ab752dbfa34ea9ab277b0e865c3f67a108))
* evaluation fixes for [#1323](https://github.com/rjskene/pipeline/issues/1323) — assemble braced token by concatenation so the legacy-placeholder guard does not misfire ([38b1c01](https://github.com/rjskene/pipeline/commit/38b1c01e476b35349988c041d43c0415e6ff4e5c))
* evaluation fixes for [#1327](https://github.com/rjskene/pipeline/issues/1327) — co-locate command_mask.py in the phase2-coexistence sandbox ([fa1bfaa](https://github.com/rjskene/pipeline/commit/fa1bfaab34317d892be7d4307a6144583bef09f1))
* evaluation fixes for [#1334](https://github.com/rjskene/pipeline/issues/1334) — anchor --changed-only at $PWD/tests; unbreak identity-guard regex ([c36447c](https://github.com/rjskene/pipeline/commit/c36447c2d9370a02fe206ded2247686bda5cd4bf))
* evaluation fixes for [#1339](https://github.com/rjskene/pipeline/issues/1339) — fixture scanner skips itself so scenario 11 fails on the marker, not self-trip ([177503c](https://github.com/rjskene/pipeline/commit/177503c73f7a47291cce6111d31cca7b255f851a))
* evaluation fixes for [#1342](https://github.com/rjskene/pipeline/issues/1342) — pin fetch-issue-attachments continuation shape (Case Y) in test-enforce-comment-trust.sh ([23da13e](https://github.com/rjskene/pipeline/commit/23da13e92cf9cb47e9502441b8427c5536cf391c))
* evaluation fixes for [#1346](https://github.com/rjskene/pipeline/issues/1346) — re-pin the median controls to the 10-record fixture ([02a9778](https://github.com/rjskene/pipeline/commit/02a9778ab074ce782a38023cc024aceaeebfd949))
* evaluation fixes for [#1347](https://github.com/rjskene/pipeline/issues/1347) — check both negation cues independently ([391226d](https://github.com/rjskene/pipeline/commit/391226dc6953e745a84626ba57bc4ccdb7612d00))
* **headless:** disable the print-mode background wait ceiling in the calibration launch ([4137d18](https://github.com/rjskene/pipeline/commit/4137d18b077975ea2cdd15adffbcb87ca975ef52))
* **hooks:** argument-position matching in block_deletions / enforce-comment-trust / restrict_paths ([19d2ef6](https://github.com/rjskene/pipeline/commit/19d2ef613bc7f40552e28a8e3b0f45fe84531d78))
* **hooks:** block_deletions allows recursive removal of literal .claude/scratch/ paths; eval skills prescribe scratch fixtures with literal-path cleanup ([5c50477](https://github.com/rjskene/pipeline/commit/5c5047706fab6910dd10b090f1e0c12aea3538f5))
* **hooks:** block_deletions exits 2 so Claude Code actually denies ([819314e](https://github.com/rjskene/pipeline/commit/819314edc88d80137c95aac85631160fe0adc9d7)), closes [#1294](https://github.com/rjskene/pipeline/issues/1294)
* **hooks:** block_deletions matches verbs in command-word position on masked text; temp-scoped rm allowed ([#1321](https://github.com/rjskene/pipeline/issues/1321)) ([ebddd03](https://github.com/rjskene/pipeline/commit/ebddd039e47331066ab74f42513fb1847bb14c00))
* **hooks:** carve out literal .claude/scratch/&lt;sub&gt; paths in block_deletions ([7ce7a32](https://github.com/rjskene/pipeline/commit/7ce7a328bb2ea7ba4b13aeb2755ea17fd56bd952)), closes [#1335](https://github.com/rjskene/pipeline/issues/1335)
* **hooks:** check-ci-skip-markers exits 2 on BLOCKED ([fcd14ed](https://github.com/rjskene/pipeline/commit/fcd14edc48e3b4ebb0e99fa7f04aaa4162487d13)), closes [#1294](https://github.com/rjskene/pipeline/issues/1294)
* **hooks:** command_mask segments() drops backslash-newline continuations so enforce-base-branch / enforce-comment-trust see the real command head ([a377ea5](https://github.com/rjskene/pipeline/commit/a377ea5a298fedbadd48232d649296595734721e))
* **hooks:** elide backslash-newline continuation in command_mask segments() ([8ce1d01](https://github.com/rjskene/pipeline/commit/8ce1d015eba7ffad7984297a40968145d9c727f7)), closes [#1342](https://github.com/rjskene/pipeline/issues/1342)
* **hooks:** enforce-base-branch exits 2 on BLOCKED ([4d4f26b](https://github.com/rjskene/pipeline/commit/4d4f26be39111afb589ee33eee8b5f685ab23a97)), closes [#1294](https://github.com/rjskene/pipeline/issues/1294)
* **hooks:** enforce-base-branch.py accepts the unexpanded PIPELINE_BASE_BRANCH token ([5c36b16](https://github.com/rjskene/pipeline/commit/5c36b16786ddb99921f11d619f7c1ed63ecacf00))
* **hooks:** enforce-base-branch.py accepts the unexpanded PIPELINE_BASE_BRANCH token ([fa9d7c6](https://github.com/rjskene/pipeline/commit/fa9d7c6fa051569ca5ef781c33dc259bbff8c0f1)), closes [#1323](https://github.com/rjskene/pipeline/issues/1323)
* **hooks:** enforce-base-branch.py decides from the command head, not raw text ([#1327](https://github.com/rjskene/pipeline/issues/1327)) ([2d7f09f](https://github.com/rjskene/pipeline/commit/2d7f09f1329d2f6d67072344b7b6a1054072369f))
* **hooks:** enforce-base-branch.py decides from the command head, not raw text (command_mask.py) ([95dea65](https://github.com/rjskene/pipeline/commit/95dea652433f50dec3880bbb893e01c63c597d0e))
* **hooks:** enforce-comment-trust decides from dequoted segments, not raw text ([#1321](https://github.com/rjskene/pipeline/issues/1321)) ([0b6d2c0](https://github.com/rjskene/pipeline/commit/0b6d2c07f8bda3d3389f354e04164d8329336741))
* **hooks:** enforce-comment-trust exits 2 on BLOCKED ([ecfa36d](https://github.com/rjskene/pipeline/commit/ecfa36dbe6276c47d15a07691dd0a770f21f2f8c)), closes [#1294](https://github.com/rjskene/pipeline/issues/1294)
* **hooks:** exit 2 on BLOCKED so the four PreToolUse guards actually deny ([bce8bd5](https://github.com/rjskene/pipeline/commit/bce8bd5410c0988ae6ea1114ac34c5f4417b5db2))
* **hooks:** make the _deny_log import itself fail-open ([1d1f6ba](https://github.com/rjskene/pipeline/commit/1d1f6ba750c4851f81a93a46c55c4bd1fc00bed7))
* **hooks:** restrict_paths skips awk/sed program operands like grep patterns ([#1321](https://github.com/rjskene/pipeline/issues/1321)) ([b9bbdab](https://github.com/rjskene/pipeline/commit/b9bbdabcfd48fc689f6f8ac1f0ca3d191c4e58ab))
* **hooks:** restrict_paths stops blocking path-shaped text, the Linux scratchpad and read-only settings loads ([1a4b4c6](https://github.com/rjskene/pipeline/commit/1a4b4c67483ceb8e8835a371c37c490e84110503))
* **plan-waves:** drop glob tokens and negated mentions from body-path extraction ([7424716](https://github.com/rjskene/pipeline/commit/74247161f9bad6b413dd1a0d2b3bab9cc2afa0ff))
* **plan-waves:** drop glob tokens and negated mentions; noglob wave comparisons ([0c3c3ba](https://github.com/rjskene/pipeline/commit/0c3c3ba54d60bf070e144a3aefefbdd558866372))
* **plan-waves:** set -f to block pathname expansion in wave comparisons ([f2a59ac](https://github.com/rjskene/pipeline/commit/f2a59ac87866bd355df2076eae8c3e2e1e51b756))
* **restrict-paths:** scan only real path arguments, add the Linux scratchpad layout, gate inline settings reads on write intent ([16b0bc6](https://github.com/rjskene/pipeline/commit/16b0bc617154e54cdca97abc3f30f2260dfe9b7e))
* **review:** tighten leak-guard header wording on REPO_ROOT vs the shared repo ([4b0b51d](https://github.com/rjskene/pipeline/commit/4b0b51d1a9f715f8472df4b9d968d2f4ff0bc130)), closes [#1316](https://github.com/rjskene/pipeline/issues/1316)
* **run-retro:** collapse forward/retroactive agent_id pairs in cost rollup ([1ec8d6e](https://github.com/rjskene/pipeline/commit/1ec8d6ee24217d4962b1416141407fa2e17523c5))
* **run-retro:** collapse forward/retroactive agent_id pairs in cost rollup ([f33b729](https://github.com/rjskene/pipeline/commit/f33b729fc57496225ef2e3743445396cf89df99f)), closes [#1346](https://github.com/rjskene/pipeline/issues/1346)
* **run-test-suite:** --changed-only always selects tests-dir scanner tests when the diff touches tests/ ([6ac056b](https://github.com/rjskene/pipeline/commit/6ac056b0a1f403e332919a4e5053730a3849cc4a))
* **run-test-suite:** --changed-only always selects tests-dir scanner tests when the diff touches tests/ (backlog [#65](https://github.com/rjskene/pipeline/issues/65)) ([59668fb](https://github.com/rjskene/pipeline/commit/59668fb21af77b4adc588cd603f7c1618ca8c5b3))
* **skills:** route the seven comment fetches through filter-trusted-comments.sh --json ([1b0fba6](https://github.com/rjskene/pipeline/commit/1b0fba672abe555c743c818aef2602cdaa489adb))
* **skills:** route the seven hard-denied comment fetches through filter-trusted-comments.sh --json ([6d5cdbf](https://github.com/rjskene/pipeline/commit/6d5cdbfc3e935d9ed5e3026d424a51b1af86454d))
* **tests:** peel PIPELINE_TRUST_PROFILE from the drift allowlist ([10a6cda](https://github.com/rjskene/pipeline/commit/10a6cdad8e88c35993894d67a054a59edb36a4bb))
* **tests:** pin PIPELINE_PROJECT_ROOT on every fixture setup-worktree.sh invocation ([2029414](https://github.com/rjskene/pipeline/commit/202941440a963de7ebd596fe45fd01277513c930)), closes [#1316](https://github.com/rjskene/pipeline/issues/1316)
* **tests:** setup-worktree fixture tests leak live worktrees when PIPELINE_PROJECT_ROOT is exported; post-suite leak guard ([c72ed0b](https://github.com/rjskene/pipeline/commit/c72ed0bbbd8136c5d869eac2ae506dc1596d1876))
